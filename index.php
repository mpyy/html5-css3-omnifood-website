...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a premium food delivery service with the mission to bringing affordable and healthy meals to as many people as possible.">
        <meta name="keywords" content="food,meal,delivery">
    ...
    <body>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                ...
                <div class="col span-1-of-4 box">
                    <img src="resources/img/san-francisco2.jpg" alt="San Fransisco">
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
                        3700+ happy eaters
                    </div>
